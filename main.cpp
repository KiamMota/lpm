...
static std::string nvim_config_path = get_nvim_config_path();
static std::string nvim_init_file = (nvim_config_path + "/init.lua");
static std::string nvim_plugins_path = (nvim_config_path + "/lua/plugins");
void help() {
  std::cout << "commands: \n\n"
...
const std::string build_non_nested_table(const char *table_name,
...
const std::string build_file_string(const char *github_url,
...
int main(int argn, char **argv) {
  ...
  // começa em 2 porque pula o nome do programa e o comando
